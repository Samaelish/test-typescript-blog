...
const CurrentPost = () => {
  ...
  return (
    <div className='container'>
      <header className='current'>
        ...
        <div className='current__feedback'>
          ...
          <div className='current__dislikes'>
            <svg width='27' height='24' viewBox='0 0 32 33' xmlns='http://www.w3.org/2000/svg'>
              <path
      ...
      <h1 className='current__title'>Что нужно знать об эффективной интернет-рекламе?</h1>
      <div className='current__content'>
        <img className='current__post-image' src='https://placehold.co/1920x1080' alt='' />
        <p className='current__post-description'>
          Интернет - огромный ресурс, позволяющий продвигать свои услуги практически на любую аудиторию. Ежедневно в
          сеть выходит более 5 миллиардов людей - каждый из них может увидеть вашу рекламу и стать вашим потенциальным
          клиентом. Даже небольшого процента этой аудитории будет достаточно для эффективного продвижения ваших услуг.
          Это огромное преимущество интернета перед другими каналами коммуникации. И в этом же заключается его главный
          недостаток - переизбыток информации и высокая конкуренция.{' '}
        </p>
      </div>
    </div>
  )
