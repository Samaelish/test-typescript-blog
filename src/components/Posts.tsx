        ...
        <div className='container'>
          <article className='main__post'>
            <img
              ...
              src='https://placehold.co/2560x1440'
              alt='Illustration of two people holding a large clipboard with a To Do list and a big pencil'
            />
            <div className='main__post-content'>
              <div className='main__post-heading'>
                <h2 className='main__post-title'>Что нужно знать об эффективной интернет-рекламе?</h2>
                <div className='main__feedback'>
                  ...
                  <div className='main__dislikes'>
                    <svg width='27' height='24' viewBox='0 0 32 33' fill='none' xmlns='http://www.w3.org/2000/svg'>
                      <path
              ...
              <p className='main__post-description'>
                Интернет - огромный ресурс, позволяющий продвигать свои услуги практически на любую аудиторию. Ежедневно
                в сеть выходит более 5 миллиардов людей - каждый из них может увидеть вашу рекламу и стать вашим
                потенциальным клиентом. Рассказываем, как правильно настраивать рекламу в интернете.
              </p>
              <Link to='/' className='main__readmore-link'>
                Читать далее
              </Link>
            </div>
          </article>
